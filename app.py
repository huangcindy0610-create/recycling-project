...
# 註冊 HEIF 解碼器 (解決 iPhone 圖片無法讀取問題)
...
def scan_page():
    ...
    # 封裝 UI 參數，確保即使出錯也能渲染出「小隊長介面」
    ui_params = {
        "username": user, 
        "remaining_uploads": max(0, DAILY_LIMIT - used), 
        "daily_limit": DAILY_LIMIT
    }
    ...
    # 【找回介面關鍵】：這裡傳入 username 給 result.html
